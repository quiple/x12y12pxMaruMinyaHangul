...
**마루미냐 한글**은 12픽셀 크기의 일본어 픽셀 폰트 '**[x12y12pxMaruMinya(マルミーニャ)](https://github.com/hicchicc/x12y12pxMaruMinya)**'를 기반으로 하는 한국어&middot;일본어 픽셀 폰트입니다.
...
> | 수정 및 재배포 | ✅ 가능 | 폰트를 수정하여 재배포할 수 있습니다. 재배포할 경우 OFL-1.1을 채택해야 합니다. |
